function layout(type,w,h,opt="empty",n="layout"){
  var obj=new tag(n,w,h).css({background:opt.includes("solid")?"var(--back)":"transparent",display:"flex",flexDirection:type||"column",overflow:"hidden","box-shadow":opt.includes("shadow")?"0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)":"","border-radius":opt.includes("round")?"12px":"0px","align-items":"flex-start"})
